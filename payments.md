...
- PayPal <button data-target="#paypal" class="btn btn-link" data-toggle="collapse">Details</button>
  ...
  If you would like to pay with PayPal, [let us know](mailto:contact@prometheus-science.com) and we will send you a link to a secure payment page. Note: a 3.50% service fee applies.
  {: #paypal .collapse}
...
- Wire transfer <button data-target="#wire" class="btn btn-link" data-toggle="collapse">Details</button>
  ...
  **Note: a $30 fee is added to wire transfers. Please add $30 to your payment.**  
  ...
  Please [email us](mailto:contact@prometheus-science.com) for the account #  
...
- e-interac transfer <button data-target="#einterac" class="btn btn-link" data-toggle="collapse">Details</button>
  ...
  Make payment to [payments@attalitech.com](mailto:contact@prometheus-science.com)
  {: #einterac .collapse}
...
- Credit card <button data-target="#cccad" class="btn btn-link" data-toggle="collapse">Details</button>
  ...
  If you would like to pay with a credit card, [let us know](mailto:contact@prometheus-science.com) and we will send you a link to a secure payment page. Note: a 3.50% service fee applies.
  {: #cccad .collapse}
